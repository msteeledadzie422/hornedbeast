...
function Main() {
    return (
        <main>
            <HornedBeast title="Colorado Pronghorn" imgURL="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a3/Antilocapra_americana.jpg/440px-Antilocapra_americana.jpg" />
